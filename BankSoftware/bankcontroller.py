from bankviews import Views
from bankmodels import usernamedic
from bankmodels import usernum
from bankmodels import User
from bankmodels import Banker
from bankmodels import Client
from bankmodels import Account
from createdbcsv import Database
from createdbcsv import CSV
from bankmodels import userlist
...
mydatabase.connect()
mydatabase.cursor()
mydatabase.curs.execute("DROP TABLE IF EXISTS Clients")
mydatabase.curs.execute("DROP TABLE IF EXISTS Bankers")
mydatabase.curs.execute("DROP TABLE IF EXISTS Client_Accounts")
