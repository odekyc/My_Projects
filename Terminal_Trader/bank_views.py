class Views:
	...
	def whattodo(self):
		...
		if (self.userrole=='b'):
			...
			print ("press 6 to enter trader terminal for your client")
			self.action=input("please select one from the above choices : ")
			if (self.action!='1' and self.action!='2' and self.action!='3' and self.action!='4' and self.action!='5' and self.action!='6'):
				print ("you entered an invalid response, please enter again!")
				return self.whattodo()
			elif (self.action=='1' or self.action=='2' or self.action=='3' or self.action=='4' or self.action=='5' or self.action=='6'):
				self.action+='b'
				return self.getinfo()
			...
			print ("press 5 to enter your trader terminal")
			self.action=input("please select one from the above choices : ")
	...
	def getinfo(self):
		if (self.action=='1b'):
			...
			self.clientpassword=input("please enter the client password: ")
			
		elif (self.action=='6b'):
			self.clientname=input("please enter the username of the client you want to log into trader terminal:")	
		elif (self.action=='1c'):
